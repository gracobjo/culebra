...
La empresa se constituirá bajo la forma jurídica de **Sociedad de Responsabilidad Limitada (S.R.L. / S.L.)**, óptima para compaginar la actividad tecnológica con el comercio físico secundario.

### A. Órgano de Administración
* **Estructura:** Administrador Único (o Administradores Solidarios). 
* **Justificación:** Agiliza la firma digital y los trámites de subsanación telemática en la Sede Electrónica de la Junta de Castilla y León sin ralentizar la toma de decisiones.
...
* **CNAE Secundario Obligatorio: 63.12 - Portales web.** (Habilitación legal para explotar comercialmente el *marketplace* y cobrar comisiones).
* **CNAEs Complementarios:**
  * 62.02 - Actividades de consultoría informática.
  * 63.11 - Proceso de datos, hosting y actividades relacionadas (Soporte del servidor NAS local).
  * 47.29 - Comercio al por menor de otros productos alimenticios en establecimientos especializados (Tienda física estacional de productos de Zamora).
...
* **Creación de Activo Tecnológico:** Programación desde cero de una plataforma web multi-vendedor (*marketplace*) escalable, con pasarela de pagos integrada y panel de administración independiente para productores locales.
* **Retención de Know-How y Activación:** Fijar el código fuente como propiedad industrial exclusiva de la sociedad, activándolo contablemente como un activo inmaterial amortizable.
* **Arraigo Rural:** Establecer las operaciones e infraestructura en Villardeciervos (Zamora) aprovechando los incentivos para combatir la despoblación en zonas fronterizas ("Plan de La Raya").

### B. Solvencia Técnica e Inteligencia Artificial
El desarrollo central se ejecutará de forma interna mediante la contratación por cuenta ajena a tiempo parcial del **Socio 3**, quien posee la titulación oficial de **Técnico Superior en Desarrollo de Aplicaciones Web (DAW)**. 

Para garantizar el cumplimiento de los plazos, el desarrollador empleará asistentes de **IA Generativa** en su entorno local. La IA se limitará a la optimización de código, estructuración limpia de consultas a bases de datos y testeo automatizado de ciberseguridad. El coste de las suscripciones de IA será un gasto operativo general no imputado a la subvención.

### C. Estrategia de Infraestructura Híbrida y Seguridad
Para proteger la inversión frente a contingencias físicas, el ecosistema se divide en:
1. **Infraestructura en Local (Propiedad):** Servidor NAS corporativo instalado en la oficina de Villardeciervos para almacenamiento interno, copias de seguridad encriptadas y entorno de desarrollo. Protegido por un Firewall físico perimetral. **(Sujeto a subvención)**.
2. **Entorno en Producción (Nube):** La plataforma comercial de cara al usuario final se alojará en un entorno en la nube (AWS/Azure) mediante suscripción anual, garantizando inmunidad ante sabotajes físicos o cortes eléctricos locales. **(Gasto corriente deducible, fuera de subvención)**.

---

## 3. 📊 PRESUPUESTO FINANCIERO Y AYUDAS PÚBLICAS

El presupuesto se ha ajustado estrictamente al **mínimo elegible de 30.000 €** exigido por el ICECYL en la provincia de Zamora, complementándolo con las partidas corrientes necesarias para el lanzamiento que la administración no subvenciona como inversión.
...
## 4. 📅 CALENDARIO DE HITOS DE INVERSIÓN (6 MESES)

*Nota: Ningún gasto, contrato o alta laboral puede realizarse antes de registrar la solicitud telemática en el ICECYL para preservar el efecto incentivador.*

* **Mes 1: Hito 1 – Trámites Iniciales e Infraestructura**
  * Registro de la solicitud en la Sede Electrónica del ICECYL (Sociedad en constitución).
  * Paso por notaría para constitución formal de la S.L. tras obtener el acuse de recibo.
  * Alta en Seguridad Social del desarrollador DAW (Contrato a tiempo parcial en pluriactividad).
  * Compra del hardware físico (Ordenadores, servidor NAS, Firewall) e instalación de la red.
* **Mes 2: Hito 2 – Adecuación Local y Arquitectura Web**
  * Obras de reforma de pintura, electricidad y climatización en la oficina de Villardeciervos.
  * Diseño de la arquitectura de la base de datos y maquetación de wireframes (UI/UX).
* **Mes 3: Hito 3 – Backend del Marketplace**
  * Programación del motor central de la plataforma (módulos de registro de tiendas y catálogo).
  * Despliegue de asistentes de IA para auditoría interna de la calidad del código.
* **Mes 4: Hito 4 – Frontend y Conectores de Pago**
  * Maquetación del panel público y flujos de compra del cliente.
  * Integración de pasarelas de pago seguras (Stripe/Redsys) y APIs de operadores logísticos.
  * Compra del mobiliario de oficina, báscula de pesaje y etiquetadora industrial.
* **Mes 5: Hito 5 – Despliegue en la Nube y Fase Beta**
  * Migración del marketplace final al entorno web en producción de la nube (AWS/Azure).
  * Pruebas de estrés y testeo de transacciones simuladas con perfiles de productores reales de Zamora.
* **Mes 6: Hito 6 – Lanzamiento, Capitalización y Cierre**
  * Apertura pública del marketplace en internet.
  * Capitalización de las nóminas del informático y facturas en el Activo Inmaterial de la S.L.
  * Presentación del expediente de justificación del gasto (facturas, nóminas, extractos bancarios) ante el ICECYL.
...
En Villardeciervos, a [Día] de [Mes] de 2026.

**REUNIDOS**
* De una parte, **D. [Nombre del Socio Propietario]**, con DNI [Número], en adelante el **COMODANTE**.
* De otra parte, **D. [Nombre del Socio Administrador / Promotor]**, en nombre y representación de la entidad en fase de constitución **[Denominación Social Reservada] S.L.**, en adelante el **COMODATARIO**.

Ambas partes se reconocen la capacidad legal suficiente para este acto y;

**EXPONEN**
1. Que el COMODANTE es propietario pleno del inmueble situado en la Calle/Plaza [Dirección del Local], en la localidad de Villardeciervos (Zamora).
2. Que la sociedad COMODATARIA requiere un local físico para establecer su domicilio fiscal, centro de desarrollo tecnológico y zona de exposición secundaria para el despliegue de su actividad de comercio electrónico.

**CLÁUSULAS**

* **PRIMERA. Objeto y Gratuidad:** El COMODANTE cede de forma **totalmente gratuita** el uso del inmueble descrito a la sociedad COMODATARIA. Queda prohibido expresamente el pago de cualquier contraprestación en concepto de alquiler.
* **SEGUNDA. Destino del Inmueble:** El local se destinará exclusivamente a albergar las oficinas de desarrollo informático de la plataforma *marketplace*, la infraestructura de servidores locales, y una representación física comercial de productos típicos asociados a la actividad de la empresa.
* **TERCERA. Duración y Permanencia:** El presente contrato se firma por una duración obligatoria de **CINCO (5) AÑOS** a contar desde la fecha de firma. Este plazo responde a la exigencia de permanencia de la inversión impuesta por las bases reguladoras del ICECYL y la Diputación de Zamora.
* **CUARTA. Obras y Reformas:** El COMODANTE autoriza expresamente al COMODATARIO a realizar cuantas obras de adecuación, reforma, pintura, climatización e instalaciones eléctricas e informáticas sean necesarias para el correcto desempeño de la actividad empresarial. Todas las facturas de dichas reformas se emitirán a nombre de la sociedad COMODATARIA, pasando las mejoras a beneficiar al inmueble a la extinción del contrato sin derecho a indemnización.
* **QUINTA. Gastos Corrientes:** Serán por cuenta de la sociedad COMODATARIA todos los gastos derivados de los suministros de agua, luz, conexión a internet, tasas de basuras y mantenimiento ordinario del local desde el día de inicio del uso.

Y en prueba de conformidad, firman las partes el presente documento por duplicado ejemplar en el lugar y fecha arriba indicados.
