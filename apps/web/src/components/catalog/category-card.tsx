...
export function CategoryCard({ category }: { category: CategoryRecord }) {
  return (
    <Link
      ...
      className="group flex min-h-36 min-w-0 flex-col justify-between rounded-3xl border border-stone-200 bg-white p-6 shadow-sm transition hover:border-emerald-300 hover:shadow-md"
    >
