...
export const BIWEEKLY_KPIS = [
  ...
  "% ventas con añadido en caja (attach) y € medios de impulso (meta 4–12)",
  "Cestas vendidas por tipo vs compra rápida 12–20 €",
  "Unidades de la lista de 8 (miel, loncheado, mermelada, queso, tote, picos, vino, mini-cata)",
  "Stock tote / sell-through / margen propio",
  "Mini-catas y % sobre visitas",
  "Contactos nuevos",
